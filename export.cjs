...
standalone=standalone.replace(/<script defer src="(security.js|privacy.js|app.js|space-effects.js)"><\/script>/g,(_,file)=>'<script>'+fs.readFileSync(path.join(source,file),'utf8')+'</script>');
